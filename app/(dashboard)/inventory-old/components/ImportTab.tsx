...
export default function ImportTab({ warehouseId, warehouseName, warehouseType }: ImportTabProps) {
  ...
  const printPDF = (id: number) => {
    window.open(`/api/inventory/import/${id}/pdf`, '_blank', 'noopener,noreferrer');
  };
          ...
          <div className="p-6 space-y-6">
            ...
            <div className="bg-gray-50 rounded-lg p-4">
              <div className="grid grid-cols-2 gap-4 text-sm">
                ...
                <div><span className="text-gray-600">Trạng thái:</span> <span className={`px-2 py-1 rounded text-xs ${selectedDetail.status === 'PENDING' ? 'bg-yellow-100 text-yellow-800' :
